...
function Register() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-950 px-4 py-10 text-white">
      <div className="w-full max-w-lg rounded-lg border border-slate-800 bg-slate-900 p-8">
        <div className="mb-8 space-y-2">
          <h1 className="text-3xl font-semibold">Create account</h1>
          <p className="text-sm text-slate-400">
            {step === 1
              ? "Set up your login details to receive an OTP."
            ...
            <div className="flex justify-between gap-2">
              {otpDigits.map((digit, index) => (
                <input
                  ...
                  className="h-14 w-12 rounded-md border border-slate-700 bg-slate-950 text-center text-xl outline-none"
                />
              ))}
            </div>
            <button
